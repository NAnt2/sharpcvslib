//////////////////////////////////////////////////////////////////////
// Class provides an interface to underlying win32 treeview control
// so you can manipulate it's appearance
//////////////////////////////////////////////////////////////////////
using System;
...
namespace SharpCvsAddIn.UI
{
    ...
    public class TreeView
    {
        ...
        {
            return (IntPtr)Functions.SendMessage( this.hwnd, Msg.TVM_GETNEXTITEM, 
        ...
        public void LockWindowUpdate( bool enable )
        {
            if (enable) 
            {
                Functions.LockWindowUpdate( this.hwnd );
            } 
            else 
            {
                Functions.LockWindowUpdate( (IntPtr)null );
            }
        }
        ...
        public IntPtr StatusImageList
        {
            get
            {
                return (IntPtr)Functions.SendMessage( this.hwnd, Msg.TVM_GETIMAGELIST,
                    Constants.TVSIL_STATE, IntPtr.Zero );
            }
            set
            {
                Functions.SendMessage( this.hwnd, Msg.TVM_SETIMAGELIST, Constants.TVSIL_STATE,
                    value );
            }
        }
        ...
        public void SetStatusImage( IntPtr item, int imageIndex )
        {
            ...
            Functions.SendMessage( this.hwnd, Msg.TVM_SETITEM, IntPtr.Zero, 
                tvitem ).ToInt32();
        }
