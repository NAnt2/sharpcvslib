...
namespace SharpCvsAddIn
{
    ...
    public class VSNetControlAttribute : Attribute
    {
        ...
        public virtual void AddControl( ICommand cmd, IController context, string tag )
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public static CommandBar GetCommandBar( string name, IController context )
        {
        ...
        protected void AddControls( string[] baseBars, ICommand cmd, 
            IController context, string tag)
        {
            // Use each of the 
