...
namespace NAnt.Contrib.Tasks {
    ...
    public class TryCatchTask : Task {
        ...
        public TaskContainer TryBlockMod {
        ...
        public CatchElement CatchBlockMod {
        ...
        public TaskContainer FinallyBlockMod {
        ...
        protected override void ExecuteTask() {
            try {
                ...
                if (CatchBlockMod != null) {
                    CatchBlockMod.Catch(e);
                } else {
                    throw;
                }
            } finally {
                if (FinallyBlockMod != null) {
                    FinallyBlockMod.Execute();
                }
            }
        }
        ...
        public class CatchElement : TaskContainer {
            ...
            private string _exception = typeof(BuildException).ToString();
            ...
            public void Catch(Exception e) {
                if (e.GetType().ToString() == this._exception) {
                    ...
                    if (Property != null) {
                        ...
                        if (e is BuildException) {
                            Project.Properties[Property] = e.ToString();
                        } else {
                            Project.Properties[Property] = ((BuildException)e).RawMessage;
                        }
                    }
